...
$saved_info = ("
<ul class='saved-box'>
	<li class='saved-title'>FACEBOOK ATTACK</li><br>
...
<div class="information"></div>
 <script>
const text = [`<?php echo "<p style=\"color:white;font-size:40px;\">Merhaba $username</p>";?>
...
<p style="color:white;font-size:25px;">$ wit-attack --facebook</p>
|███████████| (50%)<br>
|█████████████████████| (100%)<br>
